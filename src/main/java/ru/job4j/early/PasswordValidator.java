...
public class PasswordValidator {
    ...
    public static String validate(String password) {
        ...
        if (!passLowerCase) {
            throw new IllegalArgumentException("Password must contain lower characters");
        }
        if (!passUpperCase) {
            throw new IllegalArgumentException("Password must contain upper characters");
        }
        if (!passSpecSymbol) {
        ...
        if (lowerCharPass.contains("qwerty") || lowerCharPass.contains("12345")
            ...
            throw new IllegalArgumentException("The password must not contain the substrings "
